...
<CardGroup cols={2}>
  ...
  >
    Route API calls through CostHawk to track costs from any application automatically.
  </Card>
  <Card
    title="MCP Server"
    icon="terminal"
...
- **API proxy** - Route API calls through CostHawk and track per-request costs automatically
